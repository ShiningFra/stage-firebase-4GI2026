                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
                  ...
                  <div className="flex flex-col w-full sm:w-auto">
                        ...
                        <div className="">
                            {editable? (
                              <select
                              className="w-[10rem] rounded-md flex items-center bg-transparent px-3 py-2 focus:border-primary border"
              ...
              <div className="flex items-center gap-6 flex-wrap">
                {editable &&(
                  <div className="flex gap-3">
                    ...
                    <button
                      className="border border-primary p-2 rounded-md text-primary hover:text-primary  font-medium" onClick={()=>{setEditable(false)}}>
                      Cancel
                    </button>
                  </div>
                )}
