    ...
    <div className="text p-4 md:p-6 lg:p-8 mb-[18.5%]">
      <section>
        <div className="flex flex-row items-center gap-4">
          <Link
            className="flex items-center mb-3 md:mb-0 cursor-pointer text-primary font-semibold w-full md:w-[15%] hover:text-white hover:bg-primary p-2 md:p-1 justify-center gap-2 border border-primary rounded-xl"
            href={link}
          >
