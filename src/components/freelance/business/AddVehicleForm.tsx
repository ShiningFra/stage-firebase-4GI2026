  ...
  return (
    <div>
        ...
        <div className="flex flex-col">
            ...
            <input type="text" placeholder='eg. Camry, Yaris' className="p-1 border rounded focus:border-primary" />
        </div>
        <div className="flex flex-col">
            <label htmlFor="" className="mb-2">Brand:</label>
            <input type="text" className="p-1 border rounded focus:border-primary" /></div>
        <div className="flex flex-col">
            <label htmlFor="" className="mb-2">Transmisson:</label>
                <select name="" id="" className="p-1 border rounded focus:border-primary">
        ...
        <div className="flex flex-col">
            ...
            <input type="text" placeholder='eg. Toyota, Mercedes, Renault' className="p-1 border rounded focus:border-primary" /></div>
        <div className="flex flex-col">
                ...
                <div key={index}>
                    {amenity.value=='any'? (
                        <div className='flex gap-3'>
                            <input type="checkbox" className="p-1 border rounded focus:border-primary" />
        ...
        <div className="flex flex-col">
            ...
            <input type="text" className="p-1 border rounded focus:border-primary"
        ...
        <div className="flex flex-col">
            ...
            <input type="date" className="p-1 border rounded focus:border-primary" max={new Date().toISOString().split('T')[0]}/></div>
        <div className="flex flex-col">
        ...
        <div className="flex flex-col">
            ...
            <input type="number" defaultValue={0} className="p-1 border rounded focus:border-primary" /></div>
        <div className="flex flex-col">
